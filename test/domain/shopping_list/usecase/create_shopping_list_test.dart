...
main() {
  ...
  final createShoppingList = CreateShoppingList(findShoppingListByCodeGateway, saveShoppingListGateway, generateRandomCode);
  ...
  test("should create a list by code successfully", () async {
    ...
    when(saveShoppingListGateway.execute(code)).thenAnswer((realInvocation) async => Right(targetShoppingList));
